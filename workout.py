...
def days_since_workout_message_html():
    ...
    if days == 0:
        ...
        return 'You have worked out <strong>%d days ago</strong>, maybe it\'s time to hit the gym?', 'fa-exclamation-triangle'
    else:
        return 'You haven\'t worked out in <strong>%d days</strong>! Go training now!', 'fa-exclamation'
